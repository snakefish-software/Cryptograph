...
object PolybiusSquare {
  ...
  val LATIN_SQUARE =  Square(Array(Array('a',	'b', 'c',	'd', 'e'),
                                   Array('f',	'g', 'h',	'i', 'k'),
                                   Array('l',	'm', 'n',	'o', 'p'),
                                   Array('q',	'r', 's',	't', 'u'),
                                   Array('v',	'w', 'x',	'y', 'z')),
  ...
  val RUSSIAN_SQUARE_LONG = Square(Array(Array('а', 'б', 'в', 'г', 'д', 'е'),
                                         Array('ё', 'ж', 'з', 'и', 'й', 'к'),
                                         Array('л', 'м', 'н', 'о', 'п', 'р'),
                                         Array('с', 'т', 'у', 'ф', 'х', 'ц'),
                                         Array('ч', 'ш', 'щ', 'ъ', 'ы', 'ь'),
  ...
  val RUSSIAN_SQUARE_SHORT = Square(Array(Array('а', 'б', 'в', 'г', 'д', 'е'),
                                          Array('ж', 'з', 'и', 'к', 'л', 'м'),
                                          Array('н', 'о', 'п', 'р', 'с', 'т'),
                                          Array('у', 'ф', 'х', 'ц', 'ч', 'ш'),
                                          Array('щ', 'ы', 'ь', 'э', 'ю', 'я')),
  ...
  def compute(data: CharSequence, square: Square, cryptoFunc: (Array[Byte], Array[Array[Char]]) => Array[Byte]) = {
    ...
    for (i <- 0 until data.length) {
      ...
      val computedCoords = computeCoords(ch, square, rowColPair)
      if (computedCoords.isEmpty) {
        eraseArray(dataNums)
        eraseArray(rowColPair)
